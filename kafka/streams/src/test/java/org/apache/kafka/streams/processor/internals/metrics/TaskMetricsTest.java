...
public class TaskMetricsTest {
    ...
    public void shouldGetActiveProcessRatioSensor() {
        ...
        when(streamsMetrics.taskLevelSensor(THREAD_ID, TASK_ID, operation, SensorRecordingLevel.INFO))
    ...
    public void shouldGetActiveBufferCountSensor() {
        ...
        when(streamsMetrics.taskLevelSensor(THREAD_ID, TASK_ID, operation, SensorRecordingLevel.DEBUG))
                .thenReturn(expectedSensor);
    ...
    public void shouldGetCommitSensor() {
        ...
        when(streamsMetrics.taskLevelSensor(THREAD_ID, TASK_ID, operation, SensorRecordingLevel.DEBUG)).thenReturn(expectedSensor);
        when(streamsMetrics.taskLevelTagMap(THREAD_ID, TASK_ID)).thenReturn(tagMap);
        StreamsMetricsImpl.addInvocationRateAndCountToSensor(
                expectedSensor,
                TASK_LEVEL_GROUP,
    ...
    public void shouldGetDroppedRecordsSensor() {
        ...
        when(streamsMetrics.taskLevelSensor(THREAD_ID, TASK_ID, operation, SensorRecordingLevel.INFO)).thenReturn(expectedSensor);
        when(streamsMetrics.taskLevelTagMap(THREAD_ID, TASK_ID)).thenReturn(tagMap);
        StreamsMetricsImpl.addInvocationRateAndCountToSensor(
                expectedSensor,
                TASK_LEVEL_GROUP,
